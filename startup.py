""" 
In this sample, the Flask app object is contained within the login_app *module*;
that is, login_app contains an __init__.py along with relative imports. Because
...
from login_app.webapp import app
